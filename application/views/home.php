...
<head>
    ...
    <link href="<?= base_url('assets/'); ?>img/unida1.png" rel="shortcut icon">

    <title>Sistem Pengaduan UNIDA</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
                ...
                <img src="<?= base_url('assets/img/unida.png'); ?>" class="img-fluid " width="300px">
                </div>
    ...
    <div class="container">
        <div class="row mt-5 text-center">
            <div class="col">
                <h1 class="judul">Sistem Pengaduan UNIDA</h1>
                <h2 class="sub-judul">Universitas Darussalam Gontor</h2>
            </div>
        </div>

        <div class="row mt-5">
            <div class="col-md-6 mb-5">
                <h2 class="judul">Selamat datang! <i class="far fa-question"></i> </h2>
                <h3 class="sub-judul">Warga UNIDA</h3>
    ...
    <div class="container">
        <div class="row justify-content-center mt-3">
            ...
            <p class="col-5 md-auto text-center sub-judul"> Kami adalah sistem untuk melayani semua keluhan Anda, Khususnya di Kampus UNIDA GONTOR. mulai dari lupa akun,jaringan dan lain lain. Tanpa dipungut biaya apapun, alias Gratis! </p>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col md-auto text-center">
                    <div class="card mb-3" style="max-width: 500px;">
                        <div class="row no-gutters">
                            <div class="col-md-7">
                                <img src="<?= base_url('assets/img/kategori/kunci.svg'); ?>" class="card-img rounded">
                            </div>
                            <div class="col-md-5">
                                <div class="card-body">
    ...
    <footer class="sticky-footer mt-5">
        <div class="container">
            <div class="copyright text-center sub-judul">
                <span>Dibuat Oleh <i class="fas fa-smile"> AanExploite</i> </span>
