                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 m-auto">
                            <a href="<?= base_url('petugas/setujui/') . $s['id_pengaduan']; ?>" onclick="return confirm('Apakah anda yakin ingin menyetujui pengaduan ini?');" class="btn btn-primary"> <i class="fas fa-check"></i> Selesaikan</a>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
