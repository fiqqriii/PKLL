...
<ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center text-white">
        ...
        <div class="sidebar-brand-text mx-3">SIPDA</div>
    </a>
            ...
            <li class="nav-item">
                ...
                <div id="users" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('administrator/masyarakat'); ?>">pengadu</a>
                    </div>
                </div>
            </li>
            ...
            <?php if ($this->uri->segment(2) == "kategori") : ?>
                ...
                <?php elseif ($users['role'] == "petugas") : ?>
                    ...
                    <?php if ($this->uri->segment(2) == "") : ?>
                        ...
                        <?php if ($this->uri->segment(2) == "pengadu") : ?>
                            <li class="nav-item active">
                            <?php else : ?>
                            <li class="nav-item">
                            <?php endif; ?>
                            <a class="nav-link pb-0" href="<?= base_url('petugas/pengadu'); ?>">
                                <i class="fas fa-fw fa-users"></i>
                                <span>Pengadu</span></a>
                            </li>
