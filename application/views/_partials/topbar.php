     ...
     <div id="content">
         ...
         <nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
             ...
             <?php elseif ($users['role'] == "petugas") : ?>
                 <div class="nav-item">
                     <div class="text-white"><?= $user['status_petugas']; ?></div>
                 </div>
             <?php else : ?>
                 <div class="nav-item">
                     <div class="text-white">Masyarakat</div>
                 </div>
             <?php endif; ?>
             ...
             <div class="nav-item">
                <div class="row justify-content-center">
                     <div class="text-white">SISTEM PENGADUAN UNIDA</div>
                     </div>
                 </div>
             ...
             <ul class="navbar-nav ml-auto">
                 ...
                 <li class="nav-item dropdown no-arrow">
                     <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         <span class="mr-2 d-lg-inline text-white-600 small"><?= $users['nama']; ?></span>
                         <img class="img-profile rounded-circle" src="<?= base_url('assets/img/profile/') . $user['image']; ?>">
                     </a>
                     <!-- Dropdown - User Information -->
                     <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                         <a class="dropdown-item" href="#">
                             <i class="fas fa-circle fa-sm fa-fw mr-2 text-white"></i>
